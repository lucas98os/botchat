...
client.on('message', async msg => {
    ...
    `1 - Como funciona\n2 - Valores dos planos\n3 - Orçamento de peça específica\n4 - Pacotes personalizados\n5 - Outras perguntas\Por favor ,digite o número correspondente a sua escolha `
);
    ...
    if (body === '2' && msg.from.endsWith('@c.us')) {
        ...
        let media = MessageMedia.fromFilePath('./pacote.jpg');
        await client.sendMessage(msg.from, media);

        media = MessageMedia.fromFilePath('./tabela.jpg');
        await client.sendMessage(msg.from, media);
    ...
    if (body === '4' && msg.from.endsWith('@c.us')) {
        ...
        await delay(2000);
        await client.sendMessage(msg.from,
            " Tudo bem ? vamos começar o atendimento perguntando quantas peças deseja esta lavando ?."
        );
    }
